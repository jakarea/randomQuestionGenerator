...
<html>
    <head>
        ...
        <?php echo Html::style('footer/css/agency.min.css'); ?>                     
        <?php echo Html::style('footer/vendor/bootstrap/css/bootstrap.min.css'); ?>                     
        <?php echo Html::style('footer/vendor/font-awesome/css/font-awesome.min.css'); ?>                     
        <style type="text/css">
            p{
                font-size: 17px;
            }
    ...
    <body>
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <?php echo HTML::image('assets/bootstrap/img/stamford.jpg','a picture', array('class' => 'img-responsive','class'=>'img-thumbnail')); ?>
        ...
        <?php echo Html::script('footer/js/agency.min.js'); ?>
