            ...
            <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">All User</h3>
                            <form action ="user" method="Get" class="pull-right">
                                ...
                                <?php echo Form::label('status', 'Pending','required',array('class'=>'control-label')); ?>

                                <?php echo Form::radio('status', 'Pending', false); ?>

                                <?php echo Form::label('status', 'Blocked','required',array('class'=>'control-label')); ?>

                                <?php echo Form::radio('status', 'Blocked', false); ?>
                ...
                <!-- /.box-header -->
                    <div class="box-body table-responsive no-padding">
                        ...
                        <div class="text-right"><?php echo $users->links(); ?> </div>
                    </div>
                <!-- /.box-body -->
                </div>
            <!-- /.box -->
