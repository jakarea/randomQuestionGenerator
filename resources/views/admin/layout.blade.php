...
<head>
    ...
    {!! Html::style('assets/bootstrap/autocomplet/css/typeahed.css') !!}
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                {!! Html::image('assets/dist/img/user3-128x128.jpg','User Image',array('class'=>'img-circle')) !!}
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                {!! Html::image('assets/dist/img/user4-128x128.jpg','User Image',array('class'=>'img-circle')) !!}
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">You have {!! $pending !!} notifications</li>
                            <li>
                                <!-- inner menu: contains the actual data -->
                                <ul class="menu">
                                    <li>
                                        <a href="user?status=Pending">
                                            <i class="fa fa-users text-aqua"></i> {!! $pending !!} new member(s) has $pending
                                        </a>
                                    </li>
                                </ul>
                            </li>
                ...
                <?php endif;?>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            {!! Html::image('assets/dist/img/user2-160x160.jpg','User Pic',array('class'=>'user-image')) !!}
                            <span class="hidden-xs">{!! Auth::user()->fullname !!}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                 {!! Html::image('assets/dist/img/user2-160x160.jpg','User Pic',array('class'=>'img-circle')) !!}
...
{!! Html::script('assets/bootstrap/js/custom.js') !!}

{{--autocompete--}}
<script src="{{asset('assets/bootstrap/typeahead/dist/bloodhound.min.js')}}"></script>
<script src="{{asset('assets/bootstrap/typeahead/dist/typeahead.bundle.min.js')}}"></script>
<script src="{{asset('assets/bootstrap/typeahead/dist/typeahead.jquery.min.js')}}"></script>
<script src="{{asset('assets/bootstrap/typeahead/dist/typeahead.jquery.min.js')}}"></script>
<script src="{{asset('assets/bootstrap/autocomplet/js/babylontypeahed.js')}}"></script>
<script src="{{asset('assets/bootstrap/custom/auto.js')}}"></script>
